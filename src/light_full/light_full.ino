...
void loop() {
  pollCount++;
  if (pollCount > 1000 && WiFi.status() != WL_CONNECTED) {
    WiFi.begin(ssid, password);
    pollCount=0;
  }
  server.handleClient();
